...
namespace AlugaOffice.Libraries.CarrinhoCompra
{
    public class CarrinhoCompra
    {
        ...
        public void Cadastrar(ProdutoItem item)
        {
            ...
            if (_cookie.Existe(Key))
            {
                ...
                {
                    ItemLocalizado.QuantidadeProduto = ItemLocalizado.QuantidadeProduto + 1;
                }
            }
            else
            {
        ...
        public void Atualizar(ProdutoItem item)
        {
            ...
            if (ItemLocalizado != null)
            {
                ItemLocalizado.QuantidadeProduto = item.QuantidadeProduto;
                Salvar(Lista);
            }
        }
